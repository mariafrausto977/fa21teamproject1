        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CheckoutID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CheckoutNumber = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReservationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReservationCheckIn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReservationCheckOut = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WeekendPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WeekdayPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WeekdayTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WeekendTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IndividualTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Checkouts_CheckoutID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisputeReview = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PropertyID = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CheckoutID",
                table: "Reservations",
                column: "CheckoutID");
